...
public enum CreditCardType: String {
    ...
    case hipercard = "^(606282|3841)[0-9]{5,}$"
    case elo = "^((((636368)|(438935)|(504175)|(451416)|(636297))[0-9]{0,10})|((5067)|(4576)|(4011))[0-9]{0,12})$"
    case visaElectron = "^(4026|417500|4508|4844|491(3|7))"
    ...
    var validNumberLength: IndexSet {
        ...
        case .hipercard:
            return IndexSet(integersIn: 16...16)
        default:
