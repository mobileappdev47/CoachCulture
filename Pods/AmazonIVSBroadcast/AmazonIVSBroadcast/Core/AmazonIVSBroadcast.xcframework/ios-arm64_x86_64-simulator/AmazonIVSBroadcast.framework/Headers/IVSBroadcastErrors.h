...
typedef NS_ENUM(NSInteger, IVSBroadcastError) {
    ...
    /// The stage video maximum bitrate set on the IVSBroadcastConfiguration must be between 100k and 2,500k. This error is thrown
    ...
    /// The stage video minimum bitrate set on the IVSBroadcastConfiguration must be between 100k and 2,500k. This error is thrown
    ...
    /// The stage video target framerate set on the IVSBroadcastConfiguration must be between 10 and 30. This error is thrown
    ...
    /// The stage video size set on the IVSBroadcastConfiguration must have a width and height of greater than 160, less than 720, and
